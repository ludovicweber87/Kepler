...
test('isAgentSession keeps bare kepler agent sessions', () => {
	...
	assert.equal(isAgentSession('kepler-ODYS-TRAVEL-odys-front-2270-mrojzuq2'), true);
});

test('isAgentSession still keeps sessions created under the former name', () => {
...
test('stripSessionPrefix removes the current and the former prefix', () => {
	assert.equal(
		stripSessionPrefix('kepler-ODYS-TRAVEL-odys-front-2270'),
		'ODYS-TRAVEL-odys-front-2270',
	);
	assert.equal(
		stripSessionPrefix('devora-ODYS-TRAVEL-odys-front-2270'),
		'ODYS-TRAVEL-odys-front-2270',
	);
});
