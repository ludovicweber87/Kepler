      ...
      >
        ...
        <DialogContent>
          ...
          <Typography variant="caption" color="text.secondary">
            Will run: git checkout main → git pull --rebase → git checkout -b {branchName}
          </Typography>
        ...
        <DialogActions sx={{ px: 3, pb: 2.5 }}>
          ...
          <Button
            ...
            disabled={!branchName.trim() || status === "loading" || status === "success"}
            startIcon={status === "loading" ? <CircularProgress size={16} /> : undefined}
          >
            {status === "loading" ? "Creating..." : status === "success" ? "Created" : "Create branch"}
          </Button>
        </DialogActions>
      </Dialog>
