...
function getEventConfig(event: GitHubTimelineEvent): EventConfig | null {
  switch (event.event) {
    case "commented": {
      const e = event as GitHubTimelineEvent & { event: "commented"; body: string; user: { login: string } };
      ...
      return {
        ...
        text: (
          <Box>
            ...
            <Typography variant="body2" component="span"> commented</Typography>
            <Typography
              variant="body2"
              sx={{
                mt: 0.5,
    ...
    case "labeled": {
      const e = event as GitHubTimelineEvent & { event: "labeled"; label: { name: string; color: string } };
      return {
        ...
        text: (
          <Box sx={{ display: "flex", alignItems: "center", gap: 1, flexWrap: "wrap" }}>
            ...
            <Typography variant="body2" component="span"> added</Typography>
            <Chip
              label={e.label.name}
              size="small"
              sx={{
    ...
    case "unlabeled": {
      const e = event as GitHubTimelineEvent & { event: "unlabeled"; label: { name: string; color: string } };
      return {
        icon: <LabelRoundedIcon sx={{ fontSize: 16 }} />,
        color: "#808080",
        text: (
          <Box sx={{ display: "flex", alignItems: "center", gap: 1, flexWrap: "wrap" }}>
            ...
            <Typography variant="body2" component="span"> removed</Typography>
            <Chip
              label={e.label.name}
              size="small"
              sx={{
    ...
    case "assigned": {
      const e = event as GitHubTimelineEvent & { event: "assigned"; assignee: { login: string } };
      return {
        ...
        text: (
          <>
            ...
            <Typography variant="body2" component="span"> assigned </Typography>
            <Typography variant="body2" component="span" sx={{ fontWeight: 600 }}>
              {e.assignee.login}
            </Typography>
          </>
    ...
    case "unassigned": {
      const e = event as GitHubTimelineEvent & { event: "unassigned"; assignee: { login: string } };
      return {
        icon: <PersonRoundedIcon sx={{ fontSize: 16 }} />,
        color: "#808080",
        text: (
          <>
            ...
            <Typography variant="body2" component="span"> unassigned </Typography>
            <Typography variant="body2" component="span" sx={{ fontWeight: 600 }}>
              {e.assignee.login}
            </Typography>
          </>
    ...
    case "closed": {
      const e = event as GitHubTimelineEvent & { event: "closed"; state_reason?: string | null };
      ...
      return {
        ...
        text: (
          <>
            ...
            <Typography variant="body2" component="span"> closed{reason}</Typography>
          </>
        ),
      };
    }
      ...
      return {
        ...
        text: (
          <>
            ...
            <Typography variant="body2" component="span"> reopened</Typography>
          </>
        ),
      };
    case "renamed": {
      const e = event as GitHubTimelineEvent & { event: "renamed"; rename: { from: string; to: string } };
      return {
        ...
        text: (
          <Box>
            ...
            <Typography variant="body2" component="span"> renamed</Typography>
            <Typography
              variant="body2"
              sx={{ mt: 0.5, color: "text.secondary", fontSize: "0.8rem", display: "block" }}
            >
        ...
        text: (
          <>
            ...
            <Typography variant="body2" component="span">
              {" "}referenced this
              {(event as GitHubTimelineEvent & { source?: { issue?: { number: number; repository?: { full_name: string } } } }).source?.issue
      ...
      <Box sx={{ flex: 1, pt: 0.5, pb: 2 }}>
        <Box sx={{ display: "flex", alignItems: "flex-start", gap: 1 }}>
          ...
          {event.created_at && (
            <Typography
              variant="caption"
              sx={{ color: "text.secondary", whiteSpace: "nowrap", flexShrink: 0, mt: 0.2 }}
            >
